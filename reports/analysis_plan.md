...
The contemporaneous HIV/AIDS field is excluded from the primary specification because it is a WHO cause-specific mortality indicator measured in deaths per 1,000 live births and therefore directly overlaps conceptually with the mortality-based outcome. It appears only as a labeled supplementary result. Adult mortality, infant deaths, and under-five deaths are excluded for the same general outcome-overlap reason.
...
These checks were chosen for specific methodological questions, not by p-values.
